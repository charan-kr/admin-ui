    ...
    <div>
      ...
      <div>
        ...
        >
          ...
          ></Column>
          <Column filter header='Applicable Level' sortable></Column>
          <Column filter header='Eligible payment type' sortable></Column>
          <Column filter header='Message' sortable></Column>
          <Column
            filter
            header='Sponser'
            sortable
          ...
          <Column filter header='Status' sortable></Column>
