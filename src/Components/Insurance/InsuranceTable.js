      ...
      <div>
        ...
        >
          ...
          <Column
            ...
            sortable
          ></Column>
          <Column filter field='' header="Code" sortable></Column>

          <Column
            filter
            header="Minimum Qualifying Item Price "
            sortField=''
            sortable
            // filter
          ...
          ></Column>
          <Column
            header="Maximum Qualifying Item Price"
            sortable
            sortField=''
            filter
            filterElement={dateFilter}
          ...
          <Column
            filter
            field=''
            header="Number of years protected"
            sortable
          ></Column>
